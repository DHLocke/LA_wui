...
build <- read_csv(paste0(getwd(), '/output_data/building_2021-11-16.csv')) %>% glimpse 

build %<>% 
  left_join(., subdins, by = c('ID_Build' = 'ID_Build'))

build %>% 
  write_csv(., paste0(getwd(), '/output_data/building_', Sys.Date(), 'v2.csv'))#building_2021-11-16v2.csv' #added the v2 bc 2nd export that day
