...
build %>% # glimpse()
  ...
  tidylog::select(ID_Build, ID_Parcel, parcel_AIN,
                 ...
                 # build_dist_angle = build_NEAR_ANGLE, #don't think we need this 11/16/2021
                  # build_dist_to_burned = build_NEAR_DIST, #don't think we need this 11/16/2021
                  build_near_dest:build_near_exp,#building distance to destroyed and exposed
                  build_dist_to_build_ft_jod = build_dist_to_build_ft,
                  build_p_tree_10: build_p_shrub_300, # looks good for building and veg data 11/16/2021
                  build_area,
                  parcel_UseType : parcel_Imperv_P,
                  parcel_year_built = parcel_recent,
                  parcel_area) %>%
  # write_csv(., paste0(getwd(), '/output_data/building_', Sys.Date(), '.csv')) #last exported on 11/16/2021
  #next run 02_1 DINS
