...
```{r}
# TODO examine why min_dist_tree has Inf values
...
(min_dist_shrub <- read_csv('output_data/min_dist_shrub_2021-04-14.csv'))
(min_dist_tree  <- read_csv('output_data/min_dist_tree_2021-04-14.csv'))
