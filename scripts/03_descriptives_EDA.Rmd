...
# #2. FENCEATTAC fence materials #reclass no fence to NA
# #3. DECKPORCHO deck/porch materials #change 'no deck/porch' to NA 
# #4  DECKPORCHE deck/porch materials #change 'no deck/porch' to NA 
# #5. ROOFCONSTR roof materials
# #6. PATIOCOVER patio/cover materials #reclass 'no' to NA
# #7. PROPANETAN propane tank distance #reclass categories so blank is Unknown and others are in order, NA = no   tank
# #8. WINDOWPANE window panes #reclass No windows to NA
...
# #11.VENTSCREEN vents - #No Vents needs to be NA
# 
