...
build %>% describe #%>%
  ...
  #                     gsub('[[:punct:]]', '_', Sys.time()), '.csv'))   #why are these Ns different? 
...
# are the specific ones to look at?
 ...
 #elevation aspect etc correlated with roads and building density
 #build_min_dist_tree is missing I think bc of inf/Na?
 #why is build_min_dist_shrub correlated w elevation - wouldn't have thought that.
