...
tbl_desc <- tbl_stack(list(tbl_DEF, tbl_LAND)) #Dexter, am getting error that these objects are not in class 'gtsummary' - "Error: All objects in 'tbls' must be class 'gtsummary'" 
gt::gtsave(paste0(getwd(), '/figures/Table_Descript_' , Sys.Date(), '.png'))
