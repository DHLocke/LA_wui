...
(
  variable_importance <- read_csv(paste0(getwd()
    ...
    ungroup() |> 
    left_join(
      tab_labs |> tidylog::select(Variable = `Variable name`, Alias, Label, Type, Scale)
      , by = 'Variable') |> 
...
a_importance_graph_no_dins + 
  inset_element(b_g_build , left = 0.2, bottom = 0.05, right = .95, top = .9)
