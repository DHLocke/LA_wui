...
build_dins |> #tabyl(build_VENTSCREEN)
  # filter(build_DINS == 1) |> 
  tabyl(build_VENTSCREEN, damage_severity)
...
# space between plots
# https://github.com/thomasp85/patchwork/issues/46
...
(importance_pdp_2 <- a_importance_graph_dins + 
  inset_element(insets, left = 0.3, bottom = 0.01, right = .99, top = .8))
