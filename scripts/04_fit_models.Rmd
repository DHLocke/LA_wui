...
m4<-glm(damage_binary ~ parcel_year_built+build_Mean_slope_30m_DEM+build_Mean_aspect_30m_DEM+build_Mean_elev_30m+build_perc_overhang+
          parcel_Grass_P+parcel_Can_P+parcel_Soil_P+build_Mean_distroad+build_Mean_builddens, family = binomial, data = build)

AIC(m2,m4) #TO DO what's going on w number of observations here?
m4 %>% tab_model
