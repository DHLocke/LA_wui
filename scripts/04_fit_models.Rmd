...
#              , Type == 'EXP' ~ 'Exposure'
#              , TRUE ~ 'last thing')) %>% # Miranda to add last category, something meaningful
#   left_join(.
...
# DHL: I don't understand what is meant?
...
# MHM takes 2 min with 100 trees, settings here from Owen
# DHL takes 14 mins with 2000 trees
...
# # type change..
build_a_df <- build_a  %>%  data.frame()
tic(); build_a_df$predfor = predict(forest, OOB = TRUE); toc() # ~20 mins
