...
tic(); save(build_a_df, file="../Massive_forests/build_a_df_withoutdins.Rdata"); toc()
tic(); load(file="../Massive_forests/build_a_df_withoutdins.Rdata"); toc() # ~40 seconds
...
#
tic();varimp_withoutdins<-varimp(forest);toc() # ~90 seconds with 100 trees, takes 52 min with 2000 trees 
#save
tic(); save(varimp_withoutdins, file="../Massive_forests/varimp_withoutdins.Rdata"); toc()
tic(); load(file="../Massive_forests/varimp_withoutdins.Rdata"); toc() # ~40 seconds
...
#Dexter when I run like 488 it creates a plot I can view but cforest_importance is null ?
