...
TODO univariate logistic regression to pick across buffer distances

TODO stepwise regression 
TODO maximal model (pruned based on logistic)
...
## 1 read in the data
```{r}
build <- read_csv(paste0(getwd(), '/output_data/building_2021-03-23.csv'))
```
