...
# purposeful models of predictors ; no covariates

#all the below needs to be fixed. HERE HERE HERE

We have a working set of 'non-correlated' variables, create 'intentional' sets of models - Script 3
...
Take the parcel/building level model 1, 2, or 3, and add the variables for roads, building density; ?Structuredensity*Structure age interaction?
