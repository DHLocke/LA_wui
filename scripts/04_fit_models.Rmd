...
tic(); binary_without_dins_cols <-cforest(damage_binary ~ ., 
                                  ...
                                  ,controls=cforest_control(mtry=5, ntree = n_tree, mincriterion=0)); toc() #takes 12 min with full data set, settings here from Owen 

#use this to save this Random Forest 
save(binary_without_dins_cols, file="../Massive_forests/binary_without_dins_cols.Rdata")
 
load(file="../Massive_forests/binary_without_dins_cols.Rdata")

#from owen
forest<-binary_without_dins_cols # keeping Owen's naming conventions
...
tic();test <- predict(forest, type='prob',OOB = TRUE);toc() #with 100 trees, time is 180 sec
...
tic(); figRF <- cforestImpPlot(forest);toc() # ~165 seconds with 100 trees, takes 50 min with 2000 trees
